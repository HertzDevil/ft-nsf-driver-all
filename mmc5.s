...
ft_update_mmc5:
	...
	lda var_ch_TimerCalculated + WAVE_CHANS + MMC5_CH1
	and #$F8
	beq :+
	lda #$03
	sta var_ch_TimerCalculated + WAVE_CHANS + MMC5_CH1
	lda #$FF
...
@Square2: 	; MMC5 Square 2
	...
	sta $5004
	; Period table isn't limited to $7FF anymore
	lda var_ch_TimerCalculated + WAVE_CHANS + MMC5_CH2
	and #$F8
	beq :+
	lda #$03
	sta var_ch_TimerCalculated + WAVE_CHANS + MMC5_CH2
	lda #$FF
